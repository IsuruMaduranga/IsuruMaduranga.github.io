...
At WSO2 (AI R&D), I lead the AI work for enterprise integration. The main project is [WSO2 Integrator Copilot](https://mi.docs.wso2.com/en/latest/develop/mi-for-vscode/mi-copilot/), a coding agent that turns natural language into Synapse DSL and Ballerina code, with version-aware retrieval and execution-guided verification. It is used by **700+ developers a day**. I wrote a [technical deep dive](/blog/2026/building-claude-code-style-agent/) on how it works, and a series, [Harness Engineering 101](/blog/2026/harness-engineering-101/), on building agents from first principles. On the side, I build [One Code](/projects/one_code/), an open-source agent harness that runs the Claude Code workflow on any model or provider.
