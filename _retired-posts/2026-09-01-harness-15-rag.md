...
[Series index](/blog/2026/harness-engineering-101/) · [Prev](/blog/2026/harness-14-coding-agents/) ·
[Next: Epilogue - Build Your Own](/blog/2026/harness-16-epilogue/)_
...
engineering, and all of it is _search-index engineering_: none of it
...
| Agentic RAG           | give the model the search as a _tool_ and let it drive                      |
...
and _nothing_ in the left column deserves the anxiety of a proper noun.
...
This series built an agent that reads files _on demand_: the model
...
`search_docs` as a chapter 3 tool, and let the _model_ decide what to look
up, read the results, and search again with a refined query if the first
pass missed.

{% include figure.liquid loading="eager" path="assets/img/diagrams/harness-15-rag.svg" class="img-fluid rounded z-depth-1 diagram-img" zoomable=true %}
...
pull model formulates its _own_ queries mid-reasoning, sees the results,
...
series trained: _what ends up in the array? who decides, brain or body?
what does it cost, and what enforces it?_ The answers locate anything.
...
- The meta-lesson: harness eyes collapse the field's proper nouns into
  array decisions. That skill, not any single pattern, was the point of 101.
...
_[Next: Epilogue - Build Your Own](/blog/2026/harness-16-epilogue/)_
